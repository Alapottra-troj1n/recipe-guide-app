...
const showDetails = (data) => {
  ...
  <div class="col-md-8">
      ...
      <div class="card-body text-start">
          ...
          <p class="area">Type: <span>${data.strArea}</span></p>
          <p class="category">Category: <span>${data.strCategory}</span></p>
          <p class="card-text">${data.strInstructions.slice(0, 500)}...</p>
          <p class="ingredients">Ingredients: <span>${
            data.strIngredient1
          }</span><span>${data.strIngredient2}</span><span>${
data.strIngredient3
}</span><span>${data.strIngredient4}</span><span>${
data.strIngredient5
}</span><span>${data.strIngredient6}</span></p>
      </div>
